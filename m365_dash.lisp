...
(gpio-configure 'pin-12 'pin-mode-out)
                ...
                (if (= brake-light-on 0)
                    {
                        ...
                        (gpio-write 'pin-12 1) ; Turn on GPIO12 (FAN port) for brake lights
                    }
                )
            }
            {
                (if (= brake-light-on 1)
                    {
                        ...
                        (gpio-write 'pin-12 0) ; Turn off GPIO12 (FAN port) when brake is released
                    }
                )
            }
        )
